...
ONTICK() {
    ...
    for (screenI = 0; screenI < FACES_MAX; screenI++) {
        ...
        abi_CMD_TEXT_ITOA(abi_MTD_GetFaceAccelX(screenI), 0, 40, 40, TEXT_SIZE, 0, TEXT_ALIGN_CENTER, 255, 255, 255);

        abi_CMD_TEXT_ITOA(-abi_MTD_GetFaceAccelY(screenI), 0, 40, 60, TEXT_SIZE, 0, TEXT_ALIGN_CENTER, 255, 255, 255);

        abi_CMD_TEXT_ITOA(abi_MTD_GetFaceAccelZ(screenI), 0, 40, 80, TEXT_SIZE, 0, TEXT_ALIGN_CENTER, 255, 255, 255);
